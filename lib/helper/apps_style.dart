...
const Color kLightBlueSea = Color(0xffC2D8FA);
const Color kLighterBlueSea = Color(0xffF0F5FF);

const Color kDarkBlue = Color(0xff19202d);

const Color kLightGreen = Color(0XFF1FAFB0);
const Color kLighterGreen = Color(0XFFD7F9F5);

const Color kLighterPurple = Color(0XFFEEEAFF);

const Color kLighterOrange = Color(0XFFFEECDE);
